...
addChRangeClass($table, Qevix::ord('a'), Qevix::ord('z'), Qevix::ALPHA | Qevix::PRINATABLE | Qevix::TAG_NAME | Qevix::TAG_PARAM_NAME | Qevix::URL);
addChRangeClass($table, Qevix::ord('A'), Qevix::ord('Z'), Qevix::ALPHA |  Qevix::PRINATABLE | Qevix::TAG_NAME | Qevix::TAG_PARAM_NAME | Qevix::URL);
addChRangeClass($table, Qevix::ord('0'), Qevix::ord('9'), Qevix::NUMERIC | Qevix::PRINATABLE | Qevix::TAG_NAME | Qevix::TAG_PARAM_NAME | Qevix::URL);
...
addChClass($table, array('/', '.', '&', '?', '%', '-', '_', '=', ';', ':', '+', '#', '|'),  Qevix::URL | Qevix::PRINATABLE, true);
